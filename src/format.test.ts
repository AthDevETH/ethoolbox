...
import { Percentage } from './entities';;
...
describe('formatPriceImpact', () => {
    ...
    it('correctly formats a percent with 3 significant digits', () => {
        expect(formatPriceImpact(new Percentage(-1, 100000))).toBe('0.001%');
        expect(formatPriceImpact(new Percentage(-1, 1000))).toBe('0.100%');
        expect(formatPriceImpact(new Percentage(-1, 100))).toBe('1.000%');
        expect(formatPriceImpact(new Percentage(-1, 10))).toBe('10.000%');
        expect(formatPriceImpact(new Percentage(-1, 1))).toBe('100.000%');
    });
});
...
describe('formatSlippage', () => {
    ...
    it('correctly formats a percent with 3 significant digits', () => {
        expect(formatSlippage(new Percentage(1, 100000))).toBe('0.001%');
        expect(formatSlippage(new Percentage(1, 1000))).toBe('0.100%');
        expect(formatSlippage(new Percentage(1, 100))).toBe('1.000%');
        expect(formatSlippage(new Percentage(1, 10))).toBe('10.000%');
        expect(formatSlippage(new Percentage(1, 1))).toBe('100.000%');
    });
});
